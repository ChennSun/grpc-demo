...
type HiClient interface {
	SayHello(ctx context.Context, in *HiUser, opts ...grpc.CallOption) (*HiReply, error)
}
...
func (c *hiClient) SayHello(ctx context.Context, in *HiUser, opts ...grpc.CallOption) (*HiReply, error) {
	out := new(HiReply)
	err := c.cc.Invoke(ctx, "/hello.hi/sayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HiServer interface {
	SayHello(context.Context, *HiUser) (*HiReply, error)
...
func (UnimplementedHiServer) SayHello(context.Context, *HiUser) (*HiReply, error) {
...
func _Hi_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HiUser)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HiServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.hi/sayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HiServer).SayHello(ctx, req.(*HiUser))
	}
...
var Hi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hello.hi",
	HandlerType: (*HiServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "sayHello",
			Handler:    _Hi_SayHello_Handler,
		},
	},
